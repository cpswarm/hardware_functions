...
private:
    ...
    */
    ...
    /**
    * @brief The status msg from RLC
    */
    robot_local_control_msgs::Status rlc_status_;

    /**
    * @brief Services for rlc
    */
    ros::ServiceClient servicegoto_add_rlc_;
    ros::ServiceClient servicegoto_cancel_rlc_;
    ros::ServiceClient servicegoto_pause_rlc_;
    ros::ServiceClient servicegoto_query_state_rlc_;
    ros::ServiceClient servicegoto_resume_rlc_; 

    ros::ServiceClient servicepick_add_rlc_;
    ros::ServiceClient servicepick_cancel_rlc_;
    ros::ServiceClient servicepick_pause_rlc_;
    ros::ServiceClient servicepick_query_state_rlc_;
    ros::ServiceClient servicepick_resume_rlc_;

    ros::ServiceClient serviceplace_add_rlc_;
    ros::ServiceClient serviceplace_cancel_rlc_;
    ros::ServiceClient serviceplace_pause_rlc_;
    ros::ServiceClient serviceplace_query_state_rlc_;
    ros::ServiceClient serviceplace_resume_rlc_;
